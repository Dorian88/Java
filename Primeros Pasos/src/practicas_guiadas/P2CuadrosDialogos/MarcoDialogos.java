	...
	private class AccionMostrar implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(laminaTipo.dameSeleccion().equals("Mensaje")) {
				JOptionPane.showMessageDialog(MarcoDialogos.this, dameMensaje(), "Título", 0);
			}else if(laminaTipo.dameSeleccion().equals("Confirmar")) {
				JOptionPane.showConfirmDialog(MarcoDialogos.this, dameMensaje(), "Título", 0, 0);
			}else if(laminaTipo.dameSeleccion().equals("Entrada")) {
				JOptionPane.showInputDialog(MarcoDialogos.this, dameMensaje(), "Título", 0);
			}else if(laminaTipo.dameSeleccion().equals("Opción")) {
				JOptionPane.showOptionDialog(MarcoDialogos.this, dameMensaje(), "Título", 0, 0, null, null, null);
			}
